def setup(subparsers):
    ...
    embed.add_argument(
        ...
        choices=("esm2_t6_8M", "esm2_t12_35M", "esm2_t30_150M", "esm2_t33_650M", "esm2_t36_3B", "esm2_t48_15B",
                 "ProtT5-XL", "ProstT5", "Ankh", "Ankh-Large", "SaProt")
    )
...
def run(args):
    ...
    from trill.utils.lightning_models import ESM, CustomWriter, ProtT5, ProstT5, Ankh, SaProt
    ...
    if os.path.isdir(args.query):
        pass
    elif not args.query.endswith((".fasta", ".faa", ".fa")):
