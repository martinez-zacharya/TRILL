# Taken straight from https://github.com/openmm/openmmforcefields/blob/main/openmmforcefields/generators/template_generators.py
# Class classproperty taken from https://github.com/openmm/openmmforcefields/blob/main/openmmforcefields/utils.py
